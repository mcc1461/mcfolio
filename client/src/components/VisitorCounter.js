...
const VisitorCounter = () => {
  ...
  return (
    <div className="fixed flex items-center px-6 py-3 text-sm text-white transition transform rounded-full shadow-lg bg-gradient-to-r from-purple-700 via-fuchsia-700 to-indigo-700 top-60 right-5 sm:text-base hover:scale-105 hover:shadow-xl opacity-90">
