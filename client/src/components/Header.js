...
const Header = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-30 p-3 bg-mc-blue-darker1 flex justify-center items-center border-b-2 border-lime-300 h-[7vh] sm:h-[5vh] md:h-[6vh] lg:h-[7vh]">
